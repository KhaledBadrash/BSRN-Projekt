...
if __name__ == "__main__":
    ...
    if args.newround:
        ...
        def main(args):
            pipe_path = args.pipe_path  # Access the pipe path from arguments
            # ... use pipe_path and other functions
        ...
        if __name__ == "__main__":
            ...
            parser.add_argument('--pipe_path', help='Path to the pipe file')
            args = parser.parse_args()
            main(args)


        #python3 codeR.py -n woerter_datei 3 3 khaled 2
